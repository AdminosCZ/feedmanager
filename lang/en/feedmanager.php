...
return [
    ...
    'products' => [
        ...
        'sections' => [
            ...
            'b2b_status' => 'B2B partner feed status',
        ],
        'b2b_status' => [
            'included_default' => 'In partner feed',
            'included_force_allowed' => 'In partner feed (forced)',
            'excluded_globally' => 'Globally excluded',
            'excluded_force_excluded' => 'Forced out of feed',
            'excluded_master_off' => 'B2B switched off',
            'excluded_paused' => 'Paused for partners',
            'excluded_category' => 'Excluded via category',
        ],
        'b2b_status_detail' => [
            'included_default' => 'No rule blocks export — product flows into the feed with the standard tier threshold.',
            'included_force_allowed' => 'Per-product override "Always in B2B feed" beats all other rules (including category exclusion).',
            'excluded_globally' => 'Product has is_excluded=true — out of every output feed (B2C and B2B).',
            'excluded_force_excluded' => 'Per-product override "Always out of B2B feed" — admin explicitly excluded this product.',
            'excluded_master_off' => 'Master B2B toggle (Own catalogue tab) is off.',
            'excluded_paused' => 'Product was paused on the Pro partnery tab — temporary exclusion.',
            'excluded_category' => 'Excluded via category ":path". For a per-product exception use the "Always in B2B feed" override.',
        ],
    ...
    'shoptet_categories' => [
        ...
        'tree' => [
            ...
            'b2b_toggle_exclude' => 'Exclude this category from the B2B partner feed',
            'b2b_excluded_explicit' => 'This category is excluded from B2B (click to re-include)',
            'b2b_excluded_cascaded' => 'Excluded via parent category',
            'b2b_excluded_now' => 'Category ":title" was excluded from the B2B feed.',
            'b2b_included_now' => 'Category ":title" is back in the B2B feed.',
        ],
        'notify' => [
    ...
    'actions' => [
        ...
        'run_all_imports_description' => 'All active feeds for this source will be run in sequence. Each run takes 10–60 seconds depending on feed size.',
        ...
        'bulk_force_allow_b2b' => 'Always in B2B feed (override)',
        'bulk_force_allow_b2b_heading' => 'Always in B2B feed — override all rules?',
        'bulk_force_allow_b2b_description' => 'Selected products will appear in the partner feed even if a category or the master B2B toggle would exclude them. Global is_excluded still wins.',
        'bulk_force_exclude_b2b' => 'Always out of B2B feed (override)',
    ...
    'notifications' => [
        ...
        'run_all_no_feeds' => 'This source has no active feeds to run.',
        'run_all_done' => 'Done — all :ok of :total feeds succeeded.',
        'run_all_partial' => 'Finished with errors — :ok ok, :failed failed of :total.',
        ...
        'bulk_b2b_force_allowed' => ':count products set to "always in B2B feed".',
        'bulk_b2b_force_excluded' => ':count products set to "always out of B2B feed".',
        'bulk_b2b_override_reset' => 'B2B override reset for :count products.',
